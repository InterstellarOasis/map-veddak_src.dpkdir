   ...
   -[[ general ]]-----------------------------------------------------------------
	title : Veddak Station
	filename : veddak-final.bsp
	release date : July 30th 2008
	
	Made for the TremCentral.com/AMD Sponsored mapping competition.
   ...
   -[[ credits for textures, shaders, models, sounds, and testing ]]-----------------------
	construction : Andrew "Brain" Minarik ({NoS}Brain A.K.A. n.o.s.brain) and Nathanael "Face" Minarik ({NoS}Your Face) 
      
	Sound:  Www.SoundSnap.com

	Nicolas "jex" Jansens | jex@orodu.net, for all the shaders and textures.
	Jane "Stannum" van der Weg, for shaders.
	...
	Jaj for 'snow1' skybox. http://jaj.planetquake.gamespy.com/
	Godmil for shaders from karith.
	Amethyst7 http://amethyst7.gotdoofed.com/ shaders and textures.
	Paradox for the 'Trem | World Magazine' texture!
	Repentence for the 'Stupid Face!' writing from which he posted on my FaceBook wall with. xD
	Pizza Texture: PizzaBoxIdea.com
	Models: Lt1 and BlackRayne Studios (br_crates2, br_steeldrums, br_couches, br_freezers, br_gamesystems,
		                              br_hometheatre, br_computers, br_table).
   ...
   -[[ construction ]]------------------------------------------------------------
	brushes: 11564
	entites: 626
	build time : One month ten days
	Compile time: 20 minutes
	Build: -meta -vis -light -fast -filter -super 2
	software : gtkradiant 1.5.0 GODFATHER, q3map2build, PakScape, Photoshop CS2, MS Paint.
